...
# EXEMPTION_FORM_VACCS {.unnumbered}
...
The exemption_form_vaccs table contains details on exemption form records, organized by disease name, request ID, and vaccination code.
